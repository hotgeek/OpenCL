...
//All graphicd related maths is combined in following namespace. 
//Namespace helps us to keep related code combined and we can also extend the namespace, by keeping the names same 
//It also helps to not always use scope resolution operator when we want to use functions or types in header files
namespace vmath
{
